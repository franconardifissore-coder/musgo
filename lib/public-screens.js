      ...
      <section class="screen landing-screen">
        <div class="landing-hero">
          <div class="landing-hero-content">
            ...
            <p class="landing-subtitle">Musgo te ayuda a organizar tus plantas, entender qu&eacute; toca regar y guardar cada ficha en una experiencia clara y pensada para usar todos los d&iacute;as.</p>
            <div class="landing-copy-actions">
              <button class="btn-secondary landing-cta-sec" type="button" onclick="document.querySelector('.landing-story-list').scrollIntoView({behavior:'smooth'})">Saber m&aacute;s</button>
            ...
            <div class="landing-mockup" aria-hidden="true">
              <img src="/resources/landing/mockup-single.png" alt="" class="landing-mockup-img">
            </div>
          </div>
        </div>
