    ...
    return `
      <section class="screen landing-screen">
        ...
        <div class="landing-story-list">
          <article class="landing-story landing-story--tinted">
            <div class="landing-story-copy">
              ...
              <p class="landing-story-text">Nunca m&aacute;s te pierdas un riego. Musgo lleva la cuenta de cada planta y te muestra, de un vistazo, cu&aacute;les tienen sed hoy y qu&eacute; viene esta semana.</p>
            </div>
          ...
          <article class="landing-story">
            <div class="landing-story-copy">
              ...
              <p class="landing-story-text">A&ntilde;ade tus plantas en segundos. Saca una foto, deja que la AI reconozca la especie y a&ntilde;&aacute;dela a tu colecci&oacute;n con un click.</p>
            </div>
            <div class="landing-story-visual">
          ...
          <article class="landing-story landing-story--tinted">
            <div class="landing-story-copy">
              ...
              <p class="landing-story-text">Tu casa, mejor organizada. Crea espacios, asigna plantas y olv&iacute;date de ir una por una: riega zonas enteras con un solo toque.</p>
            </div>
            <div class="landing-story-visual">
        ...
        <div class="landing-cta-band">
          <div class="landing-cta-icon"><img src="/resources/logo vector.svg" alt="Musgo" width="50" height="50"></div>
